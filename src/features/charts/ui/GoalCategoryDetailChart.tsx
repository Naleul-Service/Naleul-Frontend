        ...
        return (
          <div key={goal.goalCategoryId} className="flex flex-col gap-3 py-4 first:pt-0 last:pb-0">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-primary-400 text-xs font-medium">{formatMinutes(goal.totalMinutes)}</span>
            </div>

            {/* 막대 차트 */}
            <div className="h-8 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartData} layout="vertical" barSize={20} margin={{ right: 52 }}>
